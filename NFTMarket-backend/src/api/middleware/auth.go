...
const CR_LOGIN_MSG_KEY string = "cache:orderbookdex:login:msg"
const CR_LOGIN_KEY string = "cache:orderbookdex:login:address:data"
const CR_LOGIN_SALT string = "gf_login_salt&$%"
