...
/**
    红黑树实现
 */
type Price is uint128; // 设置Price类型为uint128
...
library RedBlackTreeLibrary{
    ...
    Price constant EMPTY = Price.wrap(0);
    uint8 private constant RED_TRUE = 1;
    uint8 private constant RED_FALSE = 2;
    ...
    /**
     * @dev Returns the first key in the tree.（最小值）
     */
    ...
    /**
     * @dev Returns the last key in the tree.（最大值）
     */ 
    ...
    /**
     * @dev Returns the minimum key in the tree.
     */
    ...
    /**
     * @dev Returns the maximum key in the tree.
     */
